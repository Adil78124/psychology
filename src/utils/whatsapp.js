...
export const openWhatsApp = (message = '') => {
  const defaultMessage = 'Здравствуйте! Хочу записаться на консультацию в центр Sezim.';
...
export const openWhatsAppForGeneralAppointment = (language = 'ru') => {
  const messages = {
    ru: 'Здравствуйте! Хочу записаться на консультацию в центр психологической поддержки студентов Sezim.',
    kz: 'Сәлеметсіз бе! Sezim студенттерге психологиялық қолдау орталығына кеңеске жазылғым келеді.',
  };
